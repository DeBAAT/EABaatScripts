...
'
' Script Name:	ModelCountTaggedValues
' Author:		J de Baat
...
Function getExcelWorkbooks()
	...
	' strDefaultFileName = "ModelCountTaggedValues-" & getFormattedDate() & " " & getFormattedTime( "-" ) & ".xlsx"
...
sub ModelCountTaggedValues()
	...
	Session.Output( "======================================= Started ModelCountTaggedValues at " & LOGGetDisplayDate() & "!" )
	...
	Session.Output( "======================================= Finished ModelCountTaggedValues at " & LOGGetDisplayDate() & "!" )
	
end sub

ModelCountTaggedValues
